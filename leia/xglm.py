...
def replace_xglm_attention_to_flash_attention_2():
    modeling_xglm.XGLMAttention = XGLMFlashAttention2
    modeling_xglm._prepare_4d_causal_attention_mask = _prepare_4d_causal_attention_mask
...
def _prepare_4d_causal_attention_mask(attention_mask, *args, **kwargs):
    return attention_mask


class XGLMFlashAttention2(nn.Module):
    def __init__(
        self,
        embed_dim: int,
        num_heads: int,
